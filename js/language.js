var arrLang = {
    ...
    'Рус':{
        ...
        'cvar':'Система компьютерного зрения и рекомендательные системы',
        ...
        'aib':'Образовательная технология на основе ИИ для вступительных экзаменов и прокторинга',
        'cvml':'Компьютерное зрение &amp; Машинное обучение',
